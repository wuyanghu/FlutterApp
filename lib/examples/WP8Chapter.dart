...
class DragVerticalTest extends StatefulWidget {
  @override
  _DragVerticalTestState createState() => new _DragVerticalTestState();
}

class _DragVerticalTestState extends State<DragVerticalTest> {
  double _top = 40.0;
...
class _ScaleTestRouteState extends State<ScaleTestRoute> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: GestureDetector(
        //指定宽度，高度自适应
        child: Image.asset("./images/wechat.png", width: _width),
