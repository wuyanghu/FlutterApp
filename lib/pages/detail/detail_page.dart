...
import 'package:flutterapp/bean/movie_detail_bean.dart';
import 'package:flutterapp/pages/detail/detail_title_widget.dart';
import 'package:flutterapp/util/pick_img_main_color.dart';
import 'package:flutterapp/constant/constant.dart';
import 'package:flutterapp/pages/detail/score_start.dart';
import 'package:flutterapp/pages/detail/look_confirm_button.dart';
import 'dart:math' as math;
//import 'package:flutterapp/widgets/image/cached_network_image.dart';
import 'package:flutterapp/router.dart';
import 'package:flutterapp/widgets/item_count_title.dart';
import 'package:flutterapp/bean/comments_entity.dart';
import 'package:flutterapp/widgets/rating_bar.dart';
import 'package:flutterapp/pages/photo_hero_page.dart';
import 'package:flutterapp/widgets/animal_photo.dart';
    ...
    return Hero(
        ...
        child: Material(
          ...
          child: InkWell(
            ...
            onTap: () {
              Router2.push(context, Router2.personDetailPage,
              ...
              itemBuilder: (BuildContext context, int index) {
                if (index == 0 && _movieDetailBean.trailers.isNotEmpty) {
                  return GestureDetector(
                    ...
                    onTap: () {
                      Router2.push(context, Router2.playListPage,
      ...
      return SliverList(
        ...
        if (index == 0) {
          ...
          return GestureDetector(
            ...
            onTap: () {
              Router2.push(context, bean.author.alt, {'title': '个人主页'});
            },
          );
        }
      }, childCount: allCount));
