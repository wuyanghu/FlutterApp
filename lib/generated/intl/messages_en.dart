...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(d, h, m) => "${d}天${h}小时${m}分钟";

  static m1(num) => "&副本(${num})";

  static m2(name) => "是否删除文件夹：${name}？";

  static m3(time) => "创建于 ${time}";

  static m4(time) => "新建于 ${time}";

  static m5(time) => "最后更新于 ${time}";

  static m6(time) => "最近更新于 ${time}";

  static m7(time) => "最近浏览于 ${time}";

  static m8(time) => "最近上传${time}";

  static m9(version) => "设置后将产生一个新版本,确定将\"${version}\"设置为最新版本吗?";

  static m10(name, time) => "由 ${name} 分享于${time}";

  static m11(day, size, name) => "剩余${day} ${size} 所有者 ${name}";

  static m12(successCount, failCount) => "${successCount}条上传成功，${failCount}条上传失败";

  static m13(version) => "第${version}版";

  static m14(h, m) => "${h}小时${m}分钟";

  static m15(time) => "上传于 ${time}";

  static m16(m) => "${m}分钟";

  static m17(time) => "今天 ${time}";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "common_list_network_error" : MessageLookupByLibrary.simpleMessage("网络连接发生问题，请检查您的网络设置"),
    ...
    "doc_add_to_share_content" : MessageLookupByLibrary.simpleMessage("添加后将共享给目标文件夹成员"),
    "doc_add_to_share_title" : MessageLookupByLibrary.simpleMessage("确认将该文件添加至共享空间？"),
    "doc_all_cancel" : MessageLookupByLibrary.simpleMessage("全部取消"),
    "doc_belong_to_me" : MessageLookupByLibrary.simpleMessage("归我所有"),
    "doc_cancel_all_upload" : MessageLookupByLibrary.simpleMessage("是否确定取消全部正在上传的项目？"),
    "doc_cancel_favorites_fail" : MessageLookupByLibrary.simpleMessage("取消收藏失败"),
    "doc_cancel_favorites_success" : MessageLookupByLibrary.simpleMessage("已取消收藏"),
    "doc_clone_suffix" : m1,
    ...
    "doc_del_all_search_cache" : MessageLookupByLibrary.simpleMessage("确定要删除全部搜索历史？"),
    "doc_del_class" : MessageLookupByLibrary.simpleMessage("删除源文件"),
    "doc_del_fild_from_space_title" : MessageLookupByLibrary.simpleMessage("是否从当前文件夹中删除？"),
    "doc_del_file_content" : MessageLookupByLibrary.simpleMessage("你是该文件的所有者，删除后该文件将进入回收站，30天后将自动彻底删除"),
    "doc_del_file_freom_space_content" : MessageLookupByLibrary.simpleMessage("确认删除后，将无法从文件夹中访问该项目"),
    "doc_del_file_share_owner_title" : MessageLookupByLibrary.simpleMessage("是否从与我共享列表中移除？"),
    "doc_del_file_title" : MessageLookupByLibrary.simpleMessage("是否删除文件"),
    "doc_del_nearest_content" : MessageLookupByLibrary.simpleMessage("确认删除后，该内容在最近列表中将不可见"),
    "doc_del_nearest_title" : MessageLookupByLibrary.simpleMessage("是否从最近列表中删除？"),
    "doc_del_remove_completely" : MessageLookupByLibrary.simpleMessage("彻底删除"),
    "doc_del_share_owner_content" : MessageLookupByLibrary.simpleMessage("确认移除后，将无法从与我共享列表访问该项目"),
    "doc_del_space_folder_content" : MessageLookupByLibrary.simpleMessage("确认删除后，该文件夹将进入回收站，30天后将自动彻底删除"),
    ...
    "doc_empty_to_create" : MessageLookupByLibrary.simpleMessage("还没有创建文档?不妨试试"),
    "doc_error_max_64" : MessageLookupByLibrary.simpleMessage("最多可输入64个字符"),
    "doc_favorite_empty" : MessageLookupByLibrary.simpleMessage("暂无内容，你可以把文件或文件夹收藏到此处，方便以后更快的找到。"),
    ...
    "doc_move_to_share_content" : MessageLookupByLibrary.simpleMessage("移动后将共享给目标文件夹的成员"),
    "doc_move_to_share_title" : MessageLookupByLibrary.simpleMessage("确定移动该项目至共享空间?"),
    ...
    "doc_perm_add_to_folder_error" : MessageLookupByLibrary.simpleMessage("你没有权限添加至此文件夹"),
    ...
    "doc_perm_invited_success" : MessageLookupByLibrary.simpleMessage("邀请成功"),
    "doc_perm_modify_fail" : MessageLookupByLibrary.simpleMessage("用户权限设置失败"),
    "doc_perm_modify_success" : MessageLookupByLibrary.simpleMessage("用户权限设置成功"),
    "doc_perm_move_to_folder_error" : MessageLookupByLibrary.simpleMessage("你没有权限移动至此文件夹"),
    "doc_perm_owner_fail" : MessageLookupByLibrary.simpleMessage("所有者转移失败"),
    "doc_perm_owner_success" : MessageLookupByLibrary.simpleMessage("所有者转移成功"),
    "doc_perm_read" : MessageLookupByLibrary.simpleMessage("可阅读"),
    "doc_perm_remove_fail" : MessageLookupByLibrary.simpleMessage("用户移除失败"),
    "doc_perm_remove_success" : MessageLookupByLibrary.simpleMessage("用户移除成功"),
    "doc_perm_setting" : MessageLookupByLibrary.simpleMessage("权限设置"),
    "doc_perm_to_become_owner" : MessageLookupByLibrary.simpleMessage("设为所有者"),
    "doc_pop_cooperate_give_up_tip" : MessageLookupByLibrary.simpleMessage("确定放弃邀请协作者?"),
    "doc_pop_invited_cooperate" : MessageLookupByLibrary.simpleMessage("邀请协作者"),
    "doc_pop_look_all_cooperate" : MessageLookupByLibrary.simpleMessage("查看所有协作者 >"),
    ...
    "doc_screen_operation_type" : MessageLookupByLibrary.simpleMessage("最近操作"),
    ...
    "doc_trash_pop_content" : MessageLookupByLibrary.simpleMessage("删除后文档将不可恢复,确认要删除吗？"),
    ...
    "doc_upload_finish_tip" : MessageLookupByLibrary.simpleMessage("所有上传已完成"),
    ...
    "doc_upload_network_error" : MessageLookupByLibrary.simpleMessage("网络错误"),
    ...
    "doc_version_max_msg" : MessageLookupByLibrary.simpleMessage("保留最近100个版本"),
