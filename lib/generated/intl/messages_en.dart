...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "common_list_network_error": MessageLookupByLibrary.simpleMessage(
      "网络连接发生问题，请检查您的网络设置",
    ),
    ...
    "doc_add_to_share_content": MessageLookupByLibrary.simpleMessage(
      "添加后将共享给目标文件夹成员",
    ),
    "doc_add_to_share_title": MessageLookupByLibrary.simpleMessage(
      "确认将该文件添加至共享空间？",
    ),
    "doc_all_cancel": MessageLookupByLibrary.simpleMessage("全部取消"),
    "doc_belong_to_me": MessageLookupByLibrary.simpleMessage("归我所有"),
    "doc_cancel_all_upload": MessageLookupByLibrary.simpleMessage(
      "是否确定取消全部正在上传的项目？",
    ),
    "doc_cancel_favorites_fail": MessageLookupByLibrary.simpleMessage("取消收藏失败"),
    "doc_cancel_favorites_success": MessageLookupByLibrary.simpleMessage(
      "已取消收藏",
    ),
    "doc_clone_suffix": m1,
    ...
    "doc_del_all_search_cache": MessageLookupByLibrary.simpleMessage(
      "确定要删除全部搜索历史？",
    ),
    "doc_del_class": MessageLookupByLibrary.simpleMessage("删除源文件"),
    "doc_del_fild_from_space_title": MessageLookupByLibrary.simpleMessage(
      "是否从当前文件夹中删除？",
    ),
    "doc_del_file_content": MessageLookupByLibrary.simpleMessage(
      "你是该文件的所有者，删除后该文件将进入回收站，30天后将自动彻底删除",
    ),
    "doc_del_file_freom_space_content": MessageLookupByLibrary.simpleMessage(
      "确认删除后，将无法从文件夹中访问该项目",
    ),
    "doc_del_file_share_owner_title": MessageLookupByLibrary.simpleMessage(
      "是否从与我共享列表中移除？",
    ),
    "doc_del_file_title": MessageLookupByLibrary.simpleMessage("是否删除文件"),
    "doc_del_nearest_content": MessageLookupByLibrary.simpleMessage(
      "确认删除后，该内容在最近列表中将不可见",
    ),
    "doc_del_nearest_title": MessageLookupByLibrary.simpleMessage(
      "是否从最近列表中删除？",
    ),
    "doc_del_remove_completely": MessageLookupByLibrary.simpleMessage("彻底删除"),
    "doc_del_share_owner_content": MessageLookupByLibrary.simpleMessage(
    ...
    "doc_move_to_share_content": MessageLookupByLibrary.simpleMessage(
      "移动后将共享给目标文件夹的成员",
    ),
    "doc_move_to_share_title": MessageLookupByLibrary.simpleMessage(
      "确定移动该项目至共享空间?",
    ),
    ...
    "doc_perm_add_to_folder_error": MessageLookupByLibrary.simpleMessage(
      "你没有权限添加至此文件夹",
    ),
    ...
    "doc_perm_move_to_folder_error": MessageLookupByLibrary.simpleMessage(
      "你没有权限移动至此文件夹",
    ),
    ...
    "doc_pop_cooperate_give_up_tip": MessageLookupByLibrary.simpleMessage(
      "确定放弃邀请协作者?",
    ),
    "doc_pop_invited_cooperate": MessageLookupByLibrary.simpleMessage("邀请协作者"),
    "doc_pop_look_all_cooperate": MessageLookupByLibrary.simpleMessage(
      "查看所有协作者 >",
    ),
    ...
    "doc_trash_pop_content": MessageLookupByLibrary.simpleMessage(
      "删除后文档将不可恢复,确认要删除吗？",
    ),
