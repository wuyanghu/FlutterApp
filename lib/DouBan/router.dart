...
import 'package:flutterapp/DouBan/pages/detail/detail_page.dart';
import 'package:flutterapp/DouBan/pages/container_page.dart';
import 'package:flutterapp/DouBan/pages/videos_play_page.dart';
import 'package:flutterapp/DouBan/pages/search/search_page.dart';
import 'package:flutterapp/DouBan/pages/photo_hero_page.dart';
import 'package:flutterapp/DouBan/pages/person_detail_page.dart';
import 'package:flutterapp/DouBan/pages/web_view_page.dart';
...
//  }
  ...
  Router2.pushNoParams(BuildContext context, String url) {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return _getPage(url, null);
    }));
  }

  Router2.push(BuildContext context, String url, dynamic params) {
    Navigator.push(context, MaterialPageRoute(builder: (context) {
      return _getPage(url, params);
    }));
  }
