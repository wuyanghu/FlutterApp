...
import 'package:flutterapp/DouBan/pages/movie/title_widget.dart';
import 'package:flutterapp/DouBan/pages/movie/today_play_movie_widget.dart';
import 'package:flutterapp/DouBan/http/API.dart';
import 'package:flutterapp/DouBan/pages/movie/hot_soon_tab_bar.dart';
import 'package:flutterapp/DouBan/widgets/item_count_title.dart';
import 'package:flutterapp/DouBan/widgets/subject_mark_image_widget.dart';
import 'package:flutterapp/DouBan/bean/subject_entity.dart';
import 'package:flutterapp/DouBan/bean/top_item_bean.dart';
import 'package:flutterapp/DouBan/widgets/rating_bar.dart';
import 'package:flutterapp/DouBan/constant/color_constant.dart';
import 'dart:math' as math;
import 'package:flutterapp/DouBan/widgets/image/cache_img_radius.dart';
import 'package:flutterapp/DouBan/constant/constant.dart';
import 'package:flutterapp/DouBan/pages/movie/top_item_widget.dart';
import 'package:flutterapp/DouBan/router.dart';
import 'package:flutterapp/DouBan/http/http_request.dart';
...
import 'package:flutterapp/DouBan/widgets/image/LaminatedImage.dart';
import 'package:flutter/material.dart';
import 'package:flutterapp/DouBan/constant/text_size_constant.dart';
import 'package:flutterapp/DouBan/constant/color_constant.dart';
...
class _HotComingSoonWidgetState extends State<_HotComingSoonWidget> {
  ...
  Widget _getComingSoonItem(Subject comingSoonBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        Router2.push(context, Router2.detailPage, comingSoonBean.id);
      },
    );
  }
  ...
  Widget _getHotMovieItem(Subject hotMovieBean, var itemW) {
    ...
    return GestureDetector(
      ...
      onTap: () {
        Router2.push(context, Router2.detailPage, hotMovieBean.id);
      },
    );
  }
}
